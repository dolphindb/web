...
const info = 
    'web:\n' +
    'http://localhost:8432/console/?view=overview&hostname=115.239.209.123&port=8892\n'.blue.underline +
    ...
    'http://localhost:8432/console/?view=overview&hostname=115.239.209.123&port=8810\n'.blue.underline +
