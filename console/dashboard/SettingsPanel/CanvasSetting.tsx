    ...
    const canvas_collapsse: CollapseProps['items'] = [
        {
          key: '1',
          label: '基础',
          children:  <Form.Item<SettingOptions> label='标题' name='title'><Input /></Form.Item>,
        },
        {
          key: '2',
          label: '画布样式',
          children: <div>
            <Form.Item<SettingOptions> label='列数' name='column'><Input /></Form.Item>
            <Form.Item<SettingOptions> label='行数' name='row'><Input /></Form.Item>
          </div>,
        },
    ]
    return <>
