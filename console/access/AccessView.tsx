        ...
        () => [
            {
                key: 'database',
                label: t('分布式数据库'),
                children: view === 'preview' ? <AccessList category='database' /> : <AccessManage category='database' />
            },
            {
                key: 'share_table',
                label: t('共享内存表'),
                children: view === 'preview' ? <AccessList category='shared' /> : <AccessManage category='shared' />
            },
            {
                key: 'stream',
                label: t('流数据表'),
                children: view === 'preview' ? <AccessList category='stream' /> : <AccessManage category='stream' />
            },
            {
                key: 'function_view',
                label: t('函数视图'),
                children: view === 'preview' ? <AccessList category='function_view' /> : <AccessManage category='function_view' />
            },
            {
                key: 'script',
                label: t('全局权限'),
                children: view === 'preview' ? <AccessList category='script' /> : <AccessManage category='script' />
            }
        ],
        [view]
    )
