        ...
        <div className='actions'>
            ...
            <div className='operations'>
                    ...
                    <div className='icon-area'  onClick={() => setIsStartModalOpen(true)}>                      
                        <Button type='text' disabled={selectedNodes.length === 0} block icon={<Icon className='icon-start' component={SvgStart}  {...selectedNodes.length === 0 ? { color: '#515151' } : { color: '#234883' }}/>}>{t('启动')}</Button>                
                    </div>
                    
                    <div className='icon-area' onClick={() => setIsStopModalOpen(true)}>
                        <Button type='text' disabled={selectedNodes.length === 0} block icon={<Icon className='icon-stop' component={SvgStop}  {...selectedNodes.length === 0 ? { color: '#515151' } : { color: '#234883' }} />}>{t('停止')}</Button>   
                    </div>
