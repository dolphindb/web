...
function Perf() {
  ...
  return (
    <div className="perf">
      <Descriptions className="table" column={1} bordered size="small">
        ...
        <Descriptions.Item label={t("内存最大可用")}>
          {node.maxMemSize} GB
        </Descriptions.Item>
        <Descriptions.Item label={t("CPU用量")}>
          {node.cpuUsage.toFixed(1)}%
        </Descriptions.Item>
        <Descriptions.Item label={t("CPU平均负载")}>
        ...
        <Descriptions.Item label={t("硬盘读取")}>
          {Number(node.diskReadRate).to_fsize_str()}/s
        </Descriptions.Item>
        <Descriptions.Item label={t("硬盘写入")}>
        ...
        <Descriptions.Item label={t("磁盘可用空间占比")}>
          {node.diskFreeSpaceRatio.toFixed(2)}%
        </Descriptions.Item>
        ...
        <Descriptions.Item label={t("worker数")}>
          {node.workerNum}
        </Descriptions.Item>
        <Descriptions.Item label={t("excutor数")}>
          {node.executorNum}
        </Descriptions.Item>
        <Descriptions.Item label={t("前10个查询耗费中间值")}>
          {Number(node.medLast10QueryTime).to_fsize_str()} s
        </Descriptions.Item>
        <Descriptions.Item label={t("前10个查询耗费最大值")}>
          {Number(node.maxLast10QueryTime).to_fsize_str()} s
        </Descriptions.Item>
        <Descriptions.Item label={t("前100个查询耗费中间值")}>
          {Number(node.medLast100QueryTime).to_fsize_str()} s
        </Descriptions.Item>
        <Descriptions.Item label={t("前100个查询耗费最大值")}>
          {Number(node.maxLast100QueryTime).to_fsize_str()} s
        </Descriptions.Item>
        <Descriptions.Item label={t("前一分钟读磁盘容量")}>
          {Number(node.lastMinuteWriteVolume).to_fsize_str()}
        </Descriptions.Item>
        <Descriptions.Item label={t("前一分钟写磁盘容量")}>
          {Number(node.lastMinuteWriteVolume).to_fsize_str()}
        </Descriptions.Item>
