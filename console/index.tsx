    ...
    return <>
        ...
        
        {
            license && <div>
                        ...
                        license ? <div>
                            <Badge.Ribbon text={`V${version}`} color='#b5b5b5'>
                                ...
                                <Descriptions bordered size='small' column={2}>
                                    <Descriptions.Item label={t('授权类型')}>{authorizationList[license.authorization]}</Descriptions.Item>
                                    <Descriptions.Item label={t('客户端名称')}>{license.clientName}</Descriptions.Item>
                ...
                >
                    <Tag className='license' color='#f2f2f2'>{authorizationList[license.authorization]}</Tag>
                </Popover>
            </div>
        }
